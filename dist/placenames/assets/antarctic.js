          ...
          $http({
            ...
            if (features.length > 600) {
              ...
              scope.layer = L.layerGroup(polarGrid.cells.map(function (cell) {
                ...
                return L.marker(cell.weightedLatLng, {
                  icon: L.divIcon({
                    html: template
                  })
                }).on('click', function () {
...
var PolarLookUp = /*#__PURE__*/function () {
...
var PolarGrid = /*#__PURE__*/function () {
  /*
    ...
    get: function get() {
      if (!this._weightedLatLng) {
        var sum = this._points.reduce(function (sum, point) {
          return {
            lat: sum.lat + point._latLng.lat,
            lng: sum.lng + point._latLng.lng
          };
        }, {
          lat: 0,
          lng: 0
...
var PolarPoint = /*#__PURE__*/function () {
