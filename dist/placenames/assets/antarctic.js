         ...
         function _refreshAfterLookup(scope) {
            ...
            mapService.getMap().then(function (map) {
               $http.get(url).then(function (_ref2) {
                  ...
                  var cellSize = [24, 19, 12, 9, 5, 3, 2, 1, 1, 1][zoom] * 100000;
