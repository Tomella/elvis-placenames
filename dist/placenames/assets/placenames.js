...

{
   ...
   angular.module('placenames.filters', ['placenames.groups', "placenames.pills"]).directive('placenamesFilters', ['placenamesFiltersService', function (placenamesFiltersService) {
      return {
...

{
   angular.module("placenames.search", ['placenames.filters', 'placenames.authorities']).directive('placenamesClear', ['placenamesSearchService', function (placenamesSearchService) {
   ...
   }]).directive("placenamesQuickSearch", ['$timeout', 'groupsService', 'placenamesFiltersService', 'placenamesSearchService', function ($timeout, groupsService, placenamesFiltersService, placenamesSearchService) {
      return {
      ...
      return function (model) {
         ...
         buffer += "Lat " + model.location.split(" ").reverse().join("&deg; Lng ") + "&deg;<br/>Category: " + model.category + "</div>";
