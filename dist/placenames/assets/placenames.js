...
{
   angular.module("placenames.searched", ["placenames.feature"]).directive('placenamesSearched', ['searchService', function (searchService) {
      return {
         restrict: "AE",
